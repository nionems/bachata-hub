...
export default function ShopsPage() {
  ...
  const [lastUpdated, setLastUpdated] = useState<Date>(new Date())
    ...
    const fetchShops = async () => {
      ...
      setError(null)
      try {
      // Fetch with cache-busting timestamp to ensure fresh data while maintaining performance
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        <div className="text-center mb-4 sm:mb-12">
          ...
          Use code <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent font-bold">BACHATAAU</span> at checkout — every purchase helps support and grow Bachata.au for the Australian dance community!
          </p>
        </div>
          ...
          <TabsContent value="second-hand" className="mt-0">
            {secondHandShops.length === 0 ? (
              <div className="col-span-full text-center py-12 sm:py-16">
                <div className="max-w-md mx-auto">
                  <h3 className="text-xl font-semibold text-gray-700 mb-2">
                    No second hand items available
                  </h3>
                  <p className="text-gray-500 mb-6">

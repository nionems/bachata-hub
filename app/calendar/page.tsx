    ...
    <div className="container mx-auto py-6 sm:py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-4">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Bachata Calendar</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Stay updated with all Bachata events across Australia. Add this calendar to your Google Calendar to never miss an event.
          </p>
        </div>

...
export default function CompetitionsPage() {
  ...
  const filteredCompetitions = selectedState === 'All'
    ? competitionsData
    : competitionsData.filter(competition => competition.state === selectedState)

  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-green-900 mb-4">Bachata Competitions</h1>
        <p className="text-lg text-gray-600">
          Find and participate in Bachata competitions across Australia
        </p>
      </div>

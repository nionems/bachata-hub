...
export default function CalendarEmbeds() {
  ...
  const calendarParams = '&color=%23a855f7&bgcolor=%23ffffff&ctz=Australia%2FSydney&mode=MONTH&showTitle=0&showNav=1&showPrint=0&showTabs=1&showCalendars=1&showTz=0'
